...
void MainWindow::on_actionParameters_triggered()
{
    ...
    double k_ang, k_vel;
    qint8 versus_r, versus_l;
    quint8 enable_mode;
    dlg.getParams( k_ang, k_vel, versus_l, versus_r, enable_mode );

    sendMotorParams( 0, k_vel, k_ang, versus_l, enable_mode );
    // TODO error handling

    sendMotorParams( 1, k_vel, k_ang, versus_r, enable_mode );
    // TODO error handling
...
{
    ui->lineEdit_v_max->setText( tr("%1").arg( ((double)value)/1000.0, 3, 'f', 2 ) );
}
